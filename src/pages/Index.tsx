  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Турнирные таблицы</h1>
        <p className="text-xl text-gray-600">Следите за результатами и статистикой ваших любимых турниров</p>
      </div>
